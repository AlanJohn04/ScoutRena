...
export default function StudentDashboard() {
  ...
  if (!profileData || !user) {
    return <div className="min-h-screen flex items-center justify-center text-[#888888] text-base font-semibold tracking-widest uppercase">Loading Talent DNA...</div>;
  }
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end border-b border-[#ff2020]/30 pb-6 gap-6 z-10">
        <div className="flex items-center gap-6">
          ...
          <div>
            ...
            <p className="text-base text-[#ff2020] font-semibold tracking-wider uppercase mt-1">
        ...
        <div className="flex items-center gap-8 terminal-panel p-5">
          <div className="text-right">
            <span className="text-xs text-[#888888] uppercase tracking-widest font-bold block mb-1">Personal Valuation</span>
            <p className="text-4xl font-bold text-white mono-font">{profileData.currentValue.toLocaleString()} TT</p>
          </div>
          <div className="w-px h-12 bg-white/10"></div>
          <div className="text-right">
            <span className="text-xs text-[#888888] uppercase tracking-widest font-bold block mb-1">Weekly Growth</span>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 z-10">
        ...
        <div className="lg:col-span-2 flex flex-col gap-8">
          ...
          <div className="terminal-panel p-8">
            <h3 className="text-xl font-bold text-white tracking-wide mb-6">Career Stock Value History</h3>
          ...
          <div className="terminal-panel p-8">
            <h3 className="text-xl font-bold text-white tracking-wide mb-6">Soulbound SBT Achievements</h3>
          ...
          <div className="terminal-panel p-8 relative overflow-hidden border-[#ff2020]/30 group">
            ...
            <div className="flex items-center gap-3 mb-4">
              ...
              <h3 className="text-xl font-bold text-white tracking-wide">Gemini Talent DNA Scanner</h3>
            </div>
            <p className="text-base text-[#888888] mb-6 font-medium leading-relaxed max-w-2xl">
            ...
            {parseSuccess && (
              <div className="mb-6 p-4 rounded-none bg-white/10 border border-white/30 text-white text-base font-bold flex items-center justify-center gap-2">
            ...
            <button
              ...
              className="terminal-button w-full py-4 text-base font-bold text-white disabled:opacity-50 flex items-center justify-center gap-2 uppercase tracking-widest"
            >
        ...
        <div className="flex flex-col gap-8">
          ...
          <div className="terminal-panel p-8 flex flex-col items-center">
            <h3 className="text-xl font-bold text-white tracking-wide mb-6 self-start">Potential (CPI) Breakdown</h3>
            ...
            <div className="grid grid-cols-2 gap-4 w-full mt-6 border-t border-[#ff2020]/30 pt-6">
              <div className="text-center bg-black border-[#ff2020]/20 rounded-none p-4 border border-[#ff2020]/20 shadow-inner">
                <span className="text-[#888888] block text-xs font-bold tracking-widest uppercase mb-1">Future Potential</span>
                <span className="font-bold text-white text-2xl mono-font">{profileData.potentialScore}<span className="text-slate-600 text-sm">/100</span></span>
              </div>
              <div className="text-center bg-black border-[#ff2020]/20 rounded-none p-4 border border-[#ff2020]/20 shadow-inner">
                <span className="text-[#888888] block text-xs font-bold tracking-widest uppercase mb-1">Velocity</span>
          ...
          {/* AI Advisor Panel */}
          <div className="terminal-panel p-8">
            <h3 className="text-xl font-bold text-white tracking-wide mb-4 flex items-center gap-2">
              <Lightbulb className="text-[#ff2020] w-5 h-5 drop-shadow-[0_0_5px_rgba(250,204,21,0.5)]" /> AI Advisor Insights
            </h3>
            <p className="text-base text-[#cccccc] font-medium leading-relaxed bg-black border-[#ff2020]/20 rounded-none border border-[#ff2020]/20 p-5 shadow-inner">
          ...
          <div className="terminal-panel p-8">
            <h3 className="text-xl font-bold text-white tracking-wide mb-6">Company Compatibility</h3>
              ...
              {Object.entries(profileData.compatibility).map(([companyName, percentage]) => (
                <div key={companyName} className="flex flex-col gap-2">
                  <div className="flex justify-between items-end">
                    ...
                    <span className="font-bold mono-font text-[#ff2020] text-sm">{percentage as number}%</span>
                  </div>
