...
export default function LiveTicker() {
  ...
  return (
    <div className="w-full bg-black border-b border-[#ff2020]/20 py-1 overflow-hidden flex items-center select-none z-50">
      <div className="px-4 border-r border-[#ff2020]/20 flex items-center gap-2 text-[10px] font-bold text-[#ff2020] tracking-widest bg-black z-10 shrink-0">
      ...
      <div className="relative w-full overflow-hidden flex items-center">
        <div className="animate-ticker flex items-center gap-10 pl-4">
          {doubleTicker.map((item, index) => (
            <div key={index} className="flex items-center gap-1.5 text-[10px] shrink-0 font-bold tracking-widest mono-font">
